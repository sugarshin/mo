...
export const authorize = createAction(AUTHORIZE, null, payload => ({
  cookies: {
    [CIRCLECI_TOKEN]: {
      value: payload,
      option: {
...
export const signout = createAction(SIGNOUT, null, payload => ({
  cookies: { [CIRCLECI_TOKEN]: { value: null } }
}))
...
export const fetchMeReceive = createAction(FETCH_ME_RECEIVE, null, payload => ({
  camelize: true
}))

const FETCH_RECENT_BUILDS_REQUEST = 'FETCH_RECENT_BUILDS_REQUEST'
export const fetchRecentBuildsRequest = createAction(
  FETCH_RECENT_BUILDS_REQUEST
)
...
export const rebuildReceive = createAction(REBUILD_RECEIVE, null, payload => ({
  camelize: true
}))
...
export const rebuildWithoutCacheRequest = createAction(
  REBUILD_WITHOUT_CACHE_REQUEST
)
