...
export const handlerMap = {
  ...
  [actions.cancelBuildRequest]: state => ({
    ...state,
    isCancelRequesting: true
  }),
  [actions.cancelBuildReceive]: state => ({
    ...state,
    isCancelRequesting: false
  }),
  [actions.rebuildRequest]: state => ({ ...state, isRebuildRequesting: true }),
  [actions.rebuildReceive]: state => ({ ...state, isRebuildRequesting: false }),
  [actions.rebuildWithoutCacheRequest]: state => ({
    ...state,
    isRebuildRequesting: true
  }),
  [actions.rebuildWithoutCacheReceive]: state => ({
    ...state,
    isRebuildRequesting: false
  })
}
