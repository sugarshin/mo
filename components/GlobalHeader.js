...
class GlobalHeader extends PureComponent {
  render() {
    const { toggleSidemenu, isSidemenuOpen, isServer, showBackButton, hideMenuButton, router } = this.props;
    return (
      <header>
        <style jsx>{`
          header {
        ...
        {!hideMenuButton && (
          <span className='global-menu-button'><Button onClick={toggleSidemenu}>
